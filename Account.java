 ...
 * Account
 */
abstract public class Account implements AccountFunctionalities {
    ...
    //1) Everytime a new account gets created, a new debit card object should get created AT THE SAME TIME AND GET ATTACHED TO THE ACCOUNT
    //[ tight coupling]
    
    //2) Create an account but attach a debit card separately at a later point in the code execution
        //use a setter to set accountDebitCard

    //what is the abtract functionality?
    ///option 1: checkBalance();
